...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.mydinoparkwiki.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - My Dino Park Wiki",
    description: "Read the Terms of Service for My Dino Park Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - My Dino Park Wiki",
      description: "Terms and conditions for using My Dino Park Wiki.",
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: "My Dino Park Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using My Dino Park Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using My Dino Park Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and My Dino Park Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              My Dino Park Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "My Dino Park". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> My Dino Park Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of My Dino Park. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by My Dino Park Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of My Dino Park. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, MY DINO PARK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and My Dino Park Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@mydinoparkwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@mydinoparkwiki.wiki</a>
            </p>
            <p>
